"""
Addestra il modello per il riconoscimento delle emozioni facciali EfficientNetB0, pre-addestrato su ImageNet, sul dataset FERPlus
...
MODEL_DIR = os.path.join(BASE_DIR, "models", "efficientnetb0_ferplus") #al fine del confronto tra modelli, è importante salvare i modelli in una cartella dedicata all'interno del progetto, in modo da poterli confrontare facilmente e mantenere il progetto organizzato
...
checkpoint = ModelCheckpoint(
    os.path.join(MODEL_DIR, "best_model_b0_ferplus.keras"),
...
checkpoint_ft = ModelCheckpoint(
    os.path.join(MODEL_DIR, "best_model_b0_ferplus_ft.keras"),  # file separato
    monitor='val_accuracy', verbose=1, save_best_only=True, mode='max'
)
...
json_path = os.path.join(MODEL_DIR, f"history_b0_ferplus_{timestamp}.json")
...
axes[0].set_title('Accuracy - EfficientNetB0 FERPlus')
...
axes[1].set_title('Loss - EfficientNetB0 FERPlus')
...
plt.tight_layout()
plot_path = os.path.join(MODEL_DIR, f"training_plot_b0_ferplus_{timestamp}.png")
